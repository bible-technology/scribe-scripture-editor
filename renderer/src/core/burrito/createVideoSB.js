...
import burrito from '../../lib/VideoBurritoTemplate.json';
...
const createVideoSB = (
  ...
  logger.debug('createVideoSB.js', 'In createVideoSB');
  ...
  return new Promise((resolve) => {
    ...
    logger.debug('createVideoSB.js', 'Created the Video SB');
    resolve(json);
  });
};
export default createVideoSB;
