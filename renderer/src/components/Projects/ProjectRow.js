      ...
      {({ open }) => (
        <>
          ...
          >
            ...
            <td
              className="px-6 py-4 text-right text-sm font-medium relative"
              onClick={(event) => {
                event.stopPropagation();
              }}
            >
              <div className="flex items-center justify-end">
                <Disclosure.Button
                  className="flex px-1 py-2 text-sm font-medium text-left text-gray-500 rounded-lg focus:outline-none focus-visible:ring focus-visible:ring-gray-500 focus-visible:ring-opacity-75 mr-2"
                ...
                <Menu as="div" className="relative">
                  ...
                  >
                    <Menu.Items
                      className="min-w-[240px] max-w-[280px]  bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                      style={menuStyle}
                    >
    ...
    <tbody className="bg-white divide-y divide-gray-200" id="projects-list-body">
      ...
      {projects?.length !== 0 && filteredProjects && (stableSort(
        ...
        <ProjectRowItem
          ...
          setActiveNotificationCount={setActiveNotificationCount}
          handleClickStarred={handleClickStarred}
          editProject={editProject}
          setCurrentProject={setCurrentProject}
          setCallEditProject={setCallEditProject}
