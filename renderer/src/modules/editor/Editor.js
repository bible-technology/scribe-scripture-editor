...
export default function Editor({
  ...
  // eslint-disable-next-line no-nested-ternary
    <div className={`flex flex-col bg-white border-b-2 border-secondary ${editor === 'audioTranslation' ? 'md:h-[64vh] lg:h-[71vh]' : (callFrom === 'obs' && audioEnabled) ? 'max-h-[71vh]' : 'h-editor'} rounded-md shadow scrollbar-width`}>
