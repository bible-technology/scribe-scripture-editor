export const Ar = {
  ...
  'label-import-door43-resources': 'استيراد موارد مساعدة Door43',
  ...
  'label-tech-support': 'الدعم التقني',
  ...
  'label-filter': 'فلتر',
  'label-book-selection': 'اختيار الكتاب',
  'label-chapter-selection': 'اختيار الفصل',
  'label-select': 'اختر',
  'label-deselect': 'إلغاء التحديد',
  'label-start': 'ابدأ',
  'label-end': 'انتهى',
  'label-apply': 'طبق',
  'label-scope-not-selected': 'للبدء، انتقل إلى إدارة النطاق واختر الكتاب والفصول واضغط على زر التطبيق',
  'label-scope-note-audio': 'اختر الكتاب والفصل من خيار إدارة النطاق في صفحة قائمة المشاريع',
  'modal-title-scope-management': 'إدارة النطاق',
  'msg-helps-filepath': 'مسار ملف موارد المساعدة مع manifest.yaml صالح',
  'tooltip-supported-resources': 'الموارد المدعومة هي TN, TW, TQ, TA',
  'label-upload-help-resources': 'رفع موارد المساعدة',
  'msg-no-resource-for-bible-obs-download': '<div>هذا المحتوى غير متاح لهذه اللغة</div><div>يمكنك استيراد موارد <span style="font-weight:bold">Scripture Burrito</span> الخاصة بك من خلال علامة تبويب <span style="{{ fontWeight: "bold" }}">المجموعة</span>.</div><div>تعلم المزيد حول إنشاء مشاريع Scripture Burrito مع Scribe. راجع وثائق Scribe.</div>',
};
