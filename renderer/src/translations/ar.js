export const Ar = {
  ...
  'dynamic-msg-confirm-replace-panel-resource': 'تم العثور على مشروع موجود بنفس الاسم! تحقق من علامة التبويب "المؤرشفة" أو "المشاريع". اضغط على "استبدال" لاستبدال المحتوى الموجود في الكتب المتداخلة. اضغط على "إلغاء" لتجنب التغييرات.',
  'label-downloaded-resources': 'الموارد التي تم تنزيلها',
  'label-scope-not-selected': '"للبدء، انتقل إلى إدارة النطاق وحدد الكتاب والفصول وانقر على زر "',
  'modal-title-scope-management': 'إدارة النطاق',
  'btn-resolve-book': 'كتاب الحَلّ',
  'btn-done': 'تمّ',
  'btn-finish': 'إنهاء',
