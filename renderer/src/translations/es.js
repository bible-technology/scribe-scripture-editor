export const Es = {
  ...
  'label-saved-to-cloud': 'Guardado en la nube',
  ...
  'text-msg-abort-conflict-resolution': '¿Desea abortar el proceso de resolución de conflictos? Por favor, asegúrese de haber alcanzado un punto de control para continuar más tarde. El punto de control es la finalización de cada capítulo. Si aborta en el medio de un capítulo, perderá todo su progreso del capítulo y necesitará empezar el capítulo de nuevo.',
  'label-done': 'Hecho',
  ...
  'msg-conflict-resolution-duplicate-book': 'La resolución de conflictos para {{bookId}} está en progreso. ¿Quiere empezar de nuevo? Perderá todo su progreso y no se puede revertir.',
  'label-startover': 'empezar de nuevo',
